<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV_KhoiLuongCVPhatSinh.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DanhGiaThang.DanhGiaNhanVien.DanhGiaCBCNV_KhoiLuongCVPhatSinh" %>
            ...
            <table border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                    <td align="right">
                        ...
                        <asp:Button ID="btnXoaAll" runat="server" OnClientClick="return confirm('Bạn có chắc chắn xóa các bản ghi được chọn ?')"
                            Text="Xóa các bản ghi được chọn" CssClass="btn dark" OnClick="btnXoaAll_Click" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:GridView ID="dgrKhoiLuongCV3" runat="server" AutoGenerateColumns="False" BorderColor="#999999"
                            ...
                            Width="100%" AllowPaging="true" AllowSorting="True" PageSize="50" OnRowCommand="dgrKhoiLuongCV3_RowCommand"
                            ...
                            onpageindexchanging="dgrKhoiLuongCV3_PageIndexChanging">
