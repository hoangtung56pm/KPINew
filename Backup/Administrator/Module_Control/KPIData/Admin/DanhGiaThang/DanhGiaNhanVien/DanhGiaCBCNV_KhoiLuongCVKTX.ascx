<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV_KhoiLuongCVKTX.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DanhGiaThang.DanhGiaNhanVien.DanhGiaCBCNV_KhoiLuongCVKTX" %>
...
<table id="TABLE1" border="0" cellpadding="2" cellspacing="2" style="width: 100%">
    ...
    <tr>
        <td colspan="2" valign="top" style="width: 100%;">
            <b style="font-size: 14px; color: Red">2. Những công việc không thường xuyên /các dự
                án hoặc các công việc thực hiện trong thời gian ngắn </b>
        </td>
    </tr>
    <tr>
        <td valign="top" colspan="2" style="width: 100%;">
            <table border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                    <td align="right">
                        <asp:Button ID="btnUpdateDiem2" runat="server" CssClass="btn green" Text="Cập nhật"
                ...
                <tr>
                    <td>
                        <asp:GridView ID="dgrKhoiLuongCV2" runat="server" AutoGenerateColumns="False" BorderColor="#999999"
                            ...
                            Width="100%" AllowPaging="true" AllowSorting="True" PageSize="50" OnRowCommand="dgrKhoiLuongCV2_RowCommand"
                            ...
                            onpageindexchanging="dgrKhoiLuongCV2_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Nhóm CV" HeaderStyle-Width="150px">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Cam kết" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate><div style="overflow:auto; width:150px; height:100px">
