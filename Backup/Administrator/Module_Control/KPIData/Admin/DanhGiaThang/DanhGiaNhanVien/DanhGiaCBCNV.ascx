<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DanhGiaThang.DanhGiaNhanVien.DanhGiaCBCNV" %>
...
<div class="row">
    <div class="col-md-12">
        <div class="tabbable tabbable-custom boxless" style="overflow: auto; width: 1280px">
                    ...
                    <td valign="top">
                        <table class="InputBox" cellpadding="5" style="width: 100%;">
                            <tr>
                                ...
                                <td align="center">
                                    <b style="color: #dede">Quản lý CV, chủ động, LVN
                                        <br />
                                        (5%)</b>
                                </td>
                                <td align="center">
