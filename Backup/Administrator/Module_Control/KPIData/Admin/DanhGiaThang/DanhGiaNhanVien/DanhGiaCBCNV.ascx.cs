    ...
    public partial class DanhGiaCBCNV : AuthenticatedControl
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                if (ds != null)
                {
                    ...
                    {
                        lblDiemDanhGiaDonVi.Text = Math.Round(ConvertUtility.ToDouble(ds.Tables[1].Rows[0]["TotalDiemDanhGiaDonVi"].ToString()), 2, MidpointRounding.AwayFromZero).ToString() + "%";
                    }
        ...
        protected void btnSumit_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    Response.Redirect(AppEnv.AdminUrlParams("danhgianhanvienhangthang") + "&idDotDanhGia=" + dropDotDanhGia.SelectedValue);
                }
            }
        }
        ...
        protected void btnYeuCauLamLaiDanhGia_Click(object sender, EventArgs e)
        {
            ...
            if (info != null)
            {
                ...
                EmailUtility.DoSendMail(info.EmailVNG, "", "Yêu cầu lập lại đánh giá tháng " + dropDotDanhGia.SelectedItem.Text, " phụ trách của bạn thấy bạn lập đánh giá tháng chưa hợp lý. Đề nghị bạn đăng nhập phần mềm để làm lại đánh giá tháng.");
            }
        }
