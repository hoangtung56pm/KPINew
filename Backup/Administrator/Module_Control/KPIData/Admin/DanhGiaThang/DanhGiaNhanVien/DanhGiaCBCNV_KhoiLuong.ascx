<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV_KhoiLuong.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DanhGiaThang.DanhGiaNhanVien.DanhGiaCBCNV_KhoiLuong" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="dgrKhoiLuongCV1" runat="server" AutoGenerateColumns="False" BorderColor="#999999"
                            ...
                            Width="100%" AllowPaging="true" AllowSorting="True" PageSize="50" OnRowCommand="dgrKhoiLuongCV1_RowCommand"
                            ...
                            onpageindexchanging="dgrKhoiLuongCV1_PageIndexChanging">
