<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuanLyCongViecKTXVaNhanVien.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.QuanLyCongViecKTXVaNhanVien" %>
        ...
        <td >
            <table class="InputBox" border="0" cellpadding="5" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td align="center">
                        <asp:Label ID="lblTyTrongCVKeHoachThang" Font-Bold="true" ForeColor="Blue" runat="server"></asp:Label>
                    </td>
                    <td align="center">
    ...
    <tr>
        <td  align="center">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="dgrNhanVienCVKHT" AutoGenerateColumns="false" ShowFooter="true"
                            ...
                            Width="100%" PageSize="50" OnRowDataBound="dgrNhanVienCVKHT_RowDataBound" OnRowCommand="dgrNhanVienCVKHT_RowCommand">
