...
{
    public partial class QuanLyCongViecKTX : AuthenticatedControl
    {
        ...
        protected void LoadZones()
        {
            ...
            QuanLyCongViecKTXVaPSController.LoadCongViec(lstCongViec.Items, ConvertUtility.ToInt32(dropTrungTam.SelectedValue), IDPhongBan, 2, ConvertUtility.ToInt32(dropDotDanhGia.SelectedValue));
            ...
            DataTable dt = QuanLyCongViecKTXVaPSController.GetAllByParentIDNew(zoneSelected, ConvertUtility.ToInt32(dropTrungTam.SelectedValue), IDPhongBan, 2, ConvertUtility.ToInt32(dropDotDanhGia.SelectedValue));
        ...
        void UpdateCapDoCongViec()
        {
            ...
            DataTable source = QuanLyCongViecKTXVaPSController.LoadCongViecForExport(dt, ConvertUtility.ToInt32(dropTrungTam.SelectedValue), IDPhongBan, 2, IDDotDanhGia);
        ...
        void UpdateCapDoCongViec(int idTrungTam, int idDotDanhGia)
        {
            ...
            DataTable source = QuanLyCongViecKTXVaPSController.LoadCongViecForExport(dt, idTrungTam, 0, 2, idDotDanhGia);
        ...
        {
            QuanLyCongViecKTXVaPSInfo info = QuanLyCongViecKTXVaPSController.GetInfoByTen(tencongvieccha, idDotDanhGia, idTrungTam, 2);
        ...
        {
            QuanLyCongViecKTXVaPSController.DeleteAll(ConvertUtility.ToInt32(dropTrungTam.SelectedValue), 2, ConvertUtility.ToInt32(dropDotDanhGia.SelectedValue));
