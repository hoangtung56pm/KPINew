...
{
    public partial class QuanLyCongViecPSVaNhanVien : AuthenticatedControl
    {
        double tongCaNhan = 0;
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (dtNhanVien != null && dtNhanVien.Rows.Count > 0)
            {
                ...
                foreach (DataRow item in dtNhanVien.Rows)
                {
                    ...
                    DataTable dtCongViec = DotDanhGiaController.GetAllCongViecGiaoChoNhanVienKTXVaPS_6_11_2014(ConvertUtility.ToInt32(item["UserID"]), 3, ConvertUtility.ToInt32(dropDotDanhGia.SelectedValue));
                ...
                QuanLyCongViecKTXVaPSController.LoadCongViec(lstCongViecDuocGiao.Items, ConvertUtility.ToInt32(dropTrungTam.SelectedValue), 0, 3, ConvertUtility.ToInt32(dropDotDanhGia.SelectedValue));

                lstCongViec.Items.Clear();
                QuanLyCongViecKTXVaPSController.LoadCongViecChuaDuocGiao(lstCongViec.Items, ConvertUtility.ToInt32(dropTrungTam.SelectedValue), 0, 3, ConvertUtility.ToInt32(dropDotDanhGia.SelectedValue));

                if (idNhanVien > 0)
                {
                    DataTable dtCongViecTX = DotDanhGiaController.GetAllCongViecGiaoChoNhanVienKTXVaPS_6_11_2014(idNhanVien, 3, ConvertUtility.ToInt32(dropDotDanhGia.SelectedValue));
                    ...
                    dgrNhanVienCVPS.DataSource = dtCongViecTXNew;
        ...
        protected void dgrNhanVienCVPS_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void dgrNhanVienCVPS_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "TyTrongCaNhan")
            {
                foreach (GridViewRow item in dgrNhanVienCVPS.Rows)
                {
