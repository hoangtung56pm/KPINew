<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuanLyCongViecPSVaNhanVien.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.QuanLyCongViecPSVaNhanVien" %>
    ...
    <tr>
        <td >
            <table class="InputBox" border="0" cellpadding="5" cellspacing="0" width="100%">
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="lblTyTrongCVThuongXuyen"  runat="server"></asp:Label>
                    </td>
                    <td align="center">
                        <asp:Label ID="lblTyTrongCVKeHoachThang" runat="server"></asp:Label>
                    </td>
                    <td align="center">
                        <asp:Label ID="lblTyTrongCVPhatSinh" Font-Bold="true" ForeColor="Blue" runat="server"></asp:Label>
                    </td>
                    <td align="center">
    ...
    <tr>
        <td  align="center">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="dgrNhanVienCVPS" AutoGenerateColumns="false" ShowFooter="true"
                            ...
                            Width="100%" PageSize="50" OnRowDataBound="dgrNhanVienCVPS_RowDataBound" OnRowCommand="dgrNhanVienCVPS_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <HeaderTemplate>
                                        <asp:Button ID="btnTyTrongCaNhan" CommandName="TyTrongCaNhan" runat="server"  Text="Cập nhật Tỷ Trọng"
                                            CssClass="btn blue" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtTyTrongCaNhan" CssClass="form-control" Style="text-align: center" Width="70px" runat="server"
                                            Text='<%# Eval("TyTrong") %>'>
                                        </asp:TextBox>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtGLVCaNhan" CssClass="form-control" Style="text-align: center" Width="70px" runat="server"
                                            Text='<%# Eval("SoGio") %>'>
                                        </asp:TextBox>
                                    </ItemTemplate>
                                    <FooterTemplate>
