<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuanLyCongViecKTX.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.QuanLyCongViecKTX" %>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:DropDownList Width="250px" CssClass="form-control" AutoPostBack="true" ID="dropDotDanhGiaCopy"
                                                    ...
                                                    onselectedindexchanged="dropDotDanhGiaCopy_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
