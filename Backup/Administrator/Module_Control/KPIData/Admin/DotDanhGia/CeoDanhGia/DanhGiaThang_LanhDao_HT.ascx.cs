...
{
    public partial class DanhGiaThang_LanhDao_HT : AuthenticatedControl
    {
        int idDotDanhGia = 0;
        DataTable dt;
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            DataTable dtUsers = UserController.GetLanhDaoBP(txtKeyword.Text, dropSearchBy.SelectedValue, ConvertUtility.ToString(ViewState["Alphabet"]), idDotDanhGia, 1);
