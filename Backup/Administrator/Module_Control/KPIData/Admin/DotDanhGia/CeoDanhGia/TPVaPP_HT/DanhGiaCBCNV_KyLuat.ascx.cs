...
namespace VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.TPVaPP_HT
{
    public partial class DanhGiaCBCNV_KyLuat : AuthenticatedControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (CurrentUser.RoleID != (int)Constants.Role.TruongBoPhanKhoiKinhDoanh && CurrentUser.RoleID != (int)Constants.Role.TruongBoPhanKhoiHoTro)
            {
        ...
        protected void btnUpdate1_Click(object sender, EventArgs e)
        {
            ...
            info.DiemThongNhat = ConvertUtility.ToDouble(txtPTDanhGia1.Text);
        ...
        protected void btnUpdate2_Click(object sender, EventArgs e)
        {
            ...
            info.DiemThongNhat = ConvertUtility.ToDouble(txtPTDanhGia2.Text);
