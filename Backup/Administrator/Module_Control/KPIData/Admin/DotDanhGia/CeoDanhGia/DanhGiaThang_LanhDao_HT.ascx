<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaThang_LanhDao_HT.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.DanhGiaThang_LanhDao_HT" %>
