<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaThang_TPVaPP_HT.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.DanhGiaThang_TPVaPP_HT" %>
