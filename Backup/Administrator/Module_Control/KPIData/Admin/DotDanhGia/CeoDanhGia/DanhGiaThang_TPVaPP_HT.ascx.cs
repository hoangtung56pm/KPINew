...
{
    public partial class DanhGiaThang_TPVaPP_HT : AuthenticatedControl
    {
        int idDotDanhGia = 0;
        DataTable dt;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (idDotDanhGia == 0)
                {
                    ...
                    Response.Redirect(AppEnv.AdminUrlParams("danhgiathang_tpvapp_ht") + "&idDotDanhGia=" + idDotDanhActive);
                }
                else
                {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            //{
            dtUsers = UserController.GetTPvaPP(txtKeyword.Text, dropSearchBy.SelectedValue, ConvertUtility.ToString(ViewState["Alphabet"]), idDotDanhGia, 1);
            //}
            //else
            //{
            //    dtUsers = UserController.GetTPvaPPByUserManager(txtKeyword.Text, dropSearchBy.SelectedValue, ConvertUtility.ToString(ViewState["Alphabet"]), idDotDanhGia, 1, CurrentUser.UserID);
            //}
