<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.LanhDao_KD.DanhGiaCBCNV" %>
                    ...
                    <td valign="top">
                        <table class="InputBox" cellpadding="5" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="textcenter colorBlue">
                                    <b>
                                        <asp:Label ID="lblLNBoPhan" runat="server"></asp:Label></b>
                                </td>
                                <td class="textcenter colorBlue">
                                    <b>
                ...
                <tr>
                    <td>
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#tab_0"><b>KỶ LUẬT VÀ PHỐI HỢP</b></a></li>
                        </ul>
