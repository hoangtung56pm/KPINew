<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.TPVaPP_KD.DanhGiaCBCNV" %>
                        ...
                        <table width="100%" border="0" class="InputBox" cellpadding="2" cellspacing="2">
                            <tr>
                                <td align="center" valign="top">
                                    <%-- <b style="color: #dede">Tỷ lệ hoàn thành</b>--%>
                                    <b style="color: #dede">KPI cá nhân
                                        <br />
                                        (50%)</b>
                                </td>
                                <td align="center" valign="top">
                                    <%--<b style="color: #dede">Điểm hiệu quả công việc</b>--%>
                                    <b style="color: #dede">Điểm đánh giá
                                        <br />
                                        đơn vị (10%)</b>
                                </td>
                                <td align="center" valign="top">
                                    <%-- <b style="color: #dede">Điểm dịch vụ khách hàng</b>--%>
                                ...
                                <td align="center" valign="top">
                                    <%-- <b style="color: #dede">Điểm sáng tạo</b>--%>
                                ...
                                <td align="center" valign="top">
                                    <%--<b style="color: #dede">Điểm thái độ làm việc</b>--%>
                                ...
                                <td align="center" valign="top">
                                    <%--<b style="color: #dede">Tổng điểm</b>--%>
