<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV_DichVuKhachHangDiemThuongPhat.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.TPVaPP_KD.DanhGiaCBCNV_DichVuKhachHangDiemThuongPhat" %>
<table id="TABLE1" border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        ...
        <td valign="top" style="width: 20%;">
            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtLyDoThuong" runat="server" TextMode="MultiLine" Rows="3" CssClass="form-control" ></asp:TextBox>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td valign="top" align="center" colspan="4" style="width: 100%;">
            <asp:Button ID="btnUpdateAll" runat="server" CssClass="btn green" Height="40px"
                Width="100px" Text="Cập  nhật" OnClick="btnUpdateAll_Click" />
        </td>
    </tr>
    <tr>
        <td valign="top" style="width: 20%;">
