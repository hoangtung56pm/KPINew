...
namespace VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.TPVaPP_KD
{
    public partial class DanhGiaCBCNV : AuthenticatedControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (idDotDanhGia == 0)
                {
                    ...
                    Response.Redirect(AppEnv.AdminUrlParams("dg_tpvapp_kd") + "&idDotDanhGia=" + idDotDotDanhDefault + "&idNhanVien=" + CurrentUser.UserID);
                }
                else
                {
        ...
        {
            Response.Redirect(AppEnv.AdminUrlParams("danhgiathang_tpvapp_kd") + "&idDotDanhGia=" + dropDotDanhGia.SelectedValue + "&idNhanVien=" + idNhanVien);
        }
