<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV_KyLuat.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.TPVaPP_KD.DanhGiaCBCNV_KyLuat" %>
    ...
    <tr>
        ...
        <td valign="top" id="td3" runat="server">
            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                <tr>
                    <td colspan="2">
                        <b style="color: Red">2. Nhiệt tình trách nhiệm với công việc<br /><br /></b>
                    </td>
                </tr>
        ...
        <td valign="top" id="td4" runat="server">
            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                <tr>
                    <td colspan="2">
                        <b style="color: Red">3. Linh hoạt sáng tạo trong công việc<br /><br /></b>
                    </td>
                </tr>
                <tr style="display: none">
                    <td>
        ...
        <td valign="top" id="td2" runat="server">
            <table width="100%" border="0" cellpadding="2" cellspacing="2">
                <tr>
                    <td colspan="2">
                        <b style="color: Red">2. Kỷ luật lao động cá nhân</b><br /><br />
                    </td>
                </tr>
                <tr>
                    <td>
