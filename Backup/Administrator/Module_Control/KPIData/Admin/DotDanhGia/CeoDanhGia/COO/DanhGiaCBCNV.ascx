<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.CeoDanhGia.COO.DanhGiaCBCNV" %>
                    ...
                    <td valign="top">
                        <table class="InputBox" cellpadding="5" style="width: 100%;">
                            <tr>
                                ...
                                <td align="center" valign="top">
                                    <b style="color: #dede">Kỹ năng làm việc<br />
                                        (5%)</b>
                                </td>
                                <td align="center" valign="top">
                            ...
                            <tr>
                                ...
                                <td align="center" style="color: Blue">
                                    <b>
                                        <asp:Label ID="lblDiemKhoiLuongCongViec" runat="server"></asp:Label></b>
                                </td>
                                <td align="center" style="color: Blue">
                                    <b>
                                        <asp:Label ID="lblDiemKyNangLamViec" runat="server"></asp:Label></b>
                                </td>
                                <td align="center" style="color: Blue">
                                    <b>
                    ...
                    <td>
                        ...
                        <%--<div style="float: left; width: 1300px;">
                            <radTS:RadTabStrip ID="RadTabStrip1" ScrollButtonsPosition="Middle" ScrollChildren="true"
                                ...
                                <Tabs>
                                    <radTS:Tab runat="server" ID="tabDVKH_DT_DP" Text="KHỐI LƯỢNG CÔNG VIỆC" TabIndex="1">
                                    </radTS:Tab>
