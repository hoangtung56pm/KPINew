...
{
    public partial class QuanLyCongViecKTXVaNhanVien : AuthenticatedControl
    {
        double tongCaNhan = 0;
        ...
        protected void btnUpdateCongViecVaoKeHoach1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dtCongViec = DotDanhGiaController.GetAllCongViecGiaoChoNhanVienKTXVaPS(idNhanVien, 2, idDotDanhGia);
        ...
        protected void dgrNhanVienCVKHT_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void dgrNhanVienCVKHT_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "TyTrongCaNhan")
            {
                foreach (GridViewRow item in dgrNhanVienCVKHT.Rows)
                {
