<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuanLyCongViecPS.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.DotDanhGia.QuanLyCongViecPS" %>
                        ...
                        <table id="Table1" class="NavBtn" width="100%">
                            <tr>
                                <td colspan="2" align="right">
                                    <asp:Button ID="btnXoaAll" runat="server" OnClientClick="return confirm('Bạn có chắc chắn xóa các bản ghi được chọn ? Toàn bộ các dữ liệu liên quan đến công việc này sẽ bị xóa.')"
