...
{
    public partial class BaoCaoTienDoThucHienDanhGiaCheckPoint : AuthenticatedControl
    {
        ...
        private string GetNoiDungTheoTrangThai(int trangthai)
        {
            if (trangthai <= 3)
            {
                return "Đã đến thời gian phải hoàn thiện đánh giá checkpoint, đề nghị bạn vào phần mềm để đánh giá và gửi cho người phụ trách trực tiếp";
            }
