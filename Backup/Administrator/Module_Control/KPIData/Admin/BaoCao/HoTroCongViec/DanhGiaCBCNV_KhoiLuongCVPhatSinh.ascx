<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhGiaCBCNV_KhoiLuongCVPhatSinh.ascx.cs"
    Inherits="VmgPortal.Modules.KPIData.Admin.HoTroCongViec.DanhGiaCBCNV_KhoiLuongCVPhatSinh" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="dgrKhoiLuongCV3" runat="server" AutoGenerateColumns="False" BorderColor="#999999"
                            ...
                            AllowPaging="true" AllowSorting="True" PageSize="20" OnRowCommand="dgrKhoiLuongCV3_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Cam kết" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtSoLieuCamKet" Rows="3" TextMode="MultiLine" Width="120px" runat="server"
                                ...
                                <asp:TemplateField Visible="false" HeaderStyle-Width="70px">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <ItemTemplate>
