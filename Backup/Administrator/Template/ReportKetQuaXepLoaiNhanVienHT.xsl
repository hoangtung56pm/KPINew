      ...
      <Worksheet>
        ...
        <Table  x:FullColumns="1" x:FullRows="1" ss:StyleID="s87">
          ...
          <Row ss:AutoFitHeight="0" ss:Height="68.25">
            ...
            <Cell ss:StyleID="s111">
              <Data ss:Type="String">KPI cá nhân (70%)</Data>
            </Cell>
            <Cell ss:StyleID="s111">
              <Data ss:Type="String">Điểm đánh giá đơn vị (10%)</Data>
            </Cell>
            <Cell ss:StyleID="s111">
              <Data ss:Type="String">Lợi nhuận công ty (10%)</Data>
            </Cell>
            <Cell ss:StyleID="s111">
              <Data ss:Type="String">Quản lý công việc, chủ động, làm việc nhóm (5%)</Data>
            </Cell>
            <Cell ss:StyleID="s111">
              <Data ss:Type="String">Kỷ luật cá nhân (5%)</Data>
            </Cell>
            <Cell ss:StyleID="s111">
