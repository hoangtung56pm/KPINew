...
namespace VmgPortal.WebControls
{
	...
	/// </summary>
	public class ImageButtonRoleAdd : System.Web.UI.WebControls.ImageButton
	{
       ...
       protected override void OnPreRender(EventArgs e)
		{
            ...
            else
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    if (dt.Rows.Count > 1)
                    {
                        pmsRole = ConvertUtility.ToBoolean(dt.Rows[0]["Role_Add"]);
                        pmsRole1 = ConvertUtility.ToBoolean(dt.Rows[1]["Role_Add"]);
