    ...
    public class CollectionPager : Control, IPostBackEventHandler
    {
        ...
        protected override void LoadViewState(object savedState)
        {
            if (savedState != null)
            {
                ...
                if (allStates[9] != null) _BindControl = (string)allStates[9];
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (_BindControl.Length > 0)
            {
                Control BoundControl = this.Page.FindControl(this._BindControl);
        ...
        static public string UpdateQueryStringItem(HttpRequest httpRequest, string queryStringKey, string newQueryStringValue)
        {
